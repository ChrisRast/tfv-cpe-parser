...
describe("CPE parser", () => {
    ...
    it(
        `can parse valid 2.3 cpe string w/ formatted binding w/ an 'a' type`,
        () => {
    ...
    it(
        `can parse valid 2.3 cpe string w/ formatted binding w/ an 'o' type`,
        () => {
    ...
    it(
        `can parse valid 2.3 cpe string w/ formatted binding w/ an 'h' type`,
        () => {
     ...
     */
    it(
        `can parse valid 2.3 cpe string w/ uri binding w/ an 'a' type w/ tildes`,
        () => {
    ...
    it(
        `can parse valid 2.3 cpe string w/ uri binding w/ an 'o' type w/ no tildes`,
        () => {
    ...
    it(
        `can parse valid 2.3 cpe string w/ uri binding w/ an 'h' type w/ no tildes`,
        () => {
